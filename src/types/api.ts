...
// ============ Sprint 5 Phase 6: Dashboard Sprint 5 ============

export interface Sprint5DashboardData {
  documentTypes: {
    total: number;
    active: number;
    inactive: number;
  ...
  sanctions: {
    ...
    byReason: { DOCUMENT_DELAY: number; REPEATED_OFFENSE: number; OTHER: number; SAFETY_VIOLATION: number };
    automatic: number;
    manual: number;
