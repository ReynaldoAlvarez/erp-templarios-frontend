...
async function main() {
  ...
  const clients = [
    {
      businessName: 'SIDERURGICA BOLIVIA S.R.L.',
      nit: '1023456789',
      contactName: 'Juan Pérez',
      phone: '+591 70123456',
      email: 'jperez@siderurgica.bo',
      address: 'Zona Industrial Norte, Cochabamba',
      hasCredit: true,
      creditLimit: 500000,
    },
    {
      businessName: 'IMPORTADORA ANDINA S.A.',
      nit: '2034567890',
      contactName: 'María García',
      phone: '+591 70234567',
      email: 'mgarcia@importandina.bo',
      address: 'Av. Blanco Galindo km 8, Cochabamba',
      hasCredit: true,
      creditLimit: 300000,
    },
    {
      businessName: 'METALFORJA INDUSTRIAL',
      nit: '3045678901',
      contactName: 'Carlos Mamani',
      phone: '+591 70345678',
      email: 'cmamani@metalforja.bo',
      address: 'Parque Industrial, Santa Cruz',
      hasCredit: false,
      creditLimit: null,
    },
    {
      businessName: 'CONSTRUCTORA SUR',
      nit: '4056789012',
      contactName: 'Ana Rodríguez',
      phone: '+591 70456789',
      email: 'arodriguez@constructorasur.bo',
      address: 'Zona Sur, La Paz',
      hasCredit: true,
      creditLimit: 200000,
    },
    {
      businessName: 'ACEROS DEL ORIENTE',
      nit: '5067890123',
      contactName: 'Roberto Suárez',
      phone: '+591 70567890',
      email: 'rsuarez@acerosoriente.bo',
      address: 'Zona Franca, Santa Cruz',
      hasCredit: true,
      creditLimit: 400000,
    },
  ];
  ...
  // 7. Create Sample Bill of Lading
  console.log('Creating sample Bills of Lading...');
  ...
  const bls = [
    ...
    },
    {
      ...
      vessel: 'Maersk Line',
      consignee: 'CONSTRUCTORA SUR',
      deliveryType: DeliveryType.INDIRECT,
    ...
    },
    {
      ...
      finalDestination: 'Cochabamba',
      vessel: 'MSC Maria',
      consignee: 'METALFORJA INDUSTRIAL',
      deliveryType: DeliveryType.DIRECT,
    ...
    },
    {
      ...
      totalWeight: 61234.8,
      unitCount: 18,
      cargoType: 'Bobinas de acero inoxidable',
      originPort: 'Desaguadero',
      customsPoint: 'Desaguadero',
      finalDestination: 'Santa Cruz',
      vessel: 'CMA CGM',
      consignee: 'ACEROS DEL ORIENTE',
      deliveryType: DeliveryType.DIRECT,
  ...
  for (const blData of bls) {
    if (blData.clientId) {
      await prisma.billOfLading.upsert({
        where: { blNumber: blData.blNumber },
        update: {},
        create: blData,
      });
    }
  }
  console.log(`✅ ${bls.length} sample Bills of Lading created`);
